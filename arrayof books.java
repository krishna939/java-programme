#java-programming-class SavingsAccount { static double annualInterestRate = 0; private double savingsBalance;
...
public class Main { public static void main(String[] args) { SavingsAccount saver1 = new SavingsAccount(2000.00); SavingsAccount saver2 = new SavingsAccount(3000.00);
